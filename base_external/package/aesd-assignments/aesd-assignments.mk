...
AESD_ASSIGNMENTS_VERSION = 'c2649bc28caa6dad55cbbabadd65c4638fcc6f38'
# Note: Be sure to reference the *ssh* repository URL here (not https) to work properly
# with ssh keys and the automated build/test system.
# Your site should start with git@github.com:
AESD_ASSIGNMENTS_SITE = 'git@github.com:cu-ecen-aeld/assignments-3-and-later-KarthikRevoor.git'
...
define AESD_ASSIGNMENTS_INSTALL_TARGET_CMDS
	...
	# Install autotest files
	$(INSTALL) -d $(TARGET_DIR)/bin
	$(INSTALL) -m 0755 $(@D)/assignment-autotest/test/assignment4/* $(TARGET_DIR)/bin

	# Install finder/writer utilities
